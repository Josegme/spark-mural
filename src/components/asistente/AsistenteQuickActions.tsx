...
const AsistenteQuickActions = React.forwardRef<HTMLDivElement, AsistenteQuickActionsProps>(
  ({ onOpenQRModal, onOpenRendiciones, hasEvents }, ref) => {
...
AsistenteQuickActions.displayName = "AsistenteQuickActions";

export { AsistenteQuickActions };
